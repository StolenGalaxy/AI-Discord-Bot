...
while True:
    ...
    try:
        ...
        Your discord bio is: "{selfInfo["bio"]}", this may be empty though.
        ...
        2. To react to a message and then send a message after, say #=REACT @;ID of message to react to @;URL encoded emoji @;Message to send after reacting
